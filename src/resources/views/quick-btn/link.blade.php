...
@else
    <div class="btn-group">
        <a href="{{url('quotes/create?company_id='.$contact->company->id)}}" class="btn btn-sm btn-secondary"><i class="fas fas fa-file-invoice-dollar"></i> <small>PDF</small></a>
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="{{url('killerquotes/create?company_id='.$contact->company->id)}}">Killer</a>
            <a class="dropdown-item" href="{{url('quotes/create?company_id='.$contact->company->id)}}">Pdf</a>
        </div>
    </div>
@endif
